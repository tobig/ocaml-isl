...
module Make (Ctx: IslCtx.SIG): IslAff_sigs.S with module Types := Types = struct
    ...
    let coefficient_sgn = coefficient_sgn Ctx.ctx
    let dim = dim Ctx.ctx
    ...
    let eq_basic_set = eq_basic_set Ctx.ctx
    let ge_basic_set = ge_basic_set Ctx.ctx
    let gt_basic_set = gt_basic_set Ctx.ctx
    let le_basic_set = le_basic_set Ctx.ctx
    let lt_basic_set = lt_basic_set Ctx.ctx
    ...
    let param_on_domain_space_id = param_on_domain_space_id Ctx.ctx
    ...
    let eq_set = eq_set Ctx.ctx
    let ge_set = ge_set Ctx.ctx
    let gt_set = gt_set Ctx.ctx
    let le_set = le_set Ctx.ctx
    let lt_set = lt_set Ctx.ctx
    let ne_set = ne_set Ctx.ctx
    let add = add Ctx.ctx
